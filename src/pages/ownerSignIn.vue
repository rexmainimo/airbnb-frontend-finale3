<template>
    <div>
      ...
      <form @submit.prevent="registerOwner" class="register-form">
        ...
        <div class="form-group">
          ...
          <input type="string" id="phoneNum" v-model="registerData.PhoneNum" required>
        </div>
        <div class="form-group">
    ...
    methods: {
      async registerOwner() {
        try{
          ...
          const response = await fetch("https://localhost:7156/Owner/registration",{
          method: "POST",
          headers:{
