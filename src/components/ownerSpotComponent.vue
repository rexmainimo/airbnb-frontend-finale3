    ...
    <div v-if="addSpot">
      ...
      <form @submit.prevent="handleSubmit" class="submit-form">
        ...
        <div class="form-group">
          ...
          <input type="text" id="postal" v-model="postalNum" required>
        </div>
        <div class="form-group">
          <label for="street">Street Number:</label>
          <input type="text" id="street" v-model="streetNum" required>
        </div>
        <div class="form-group">
          <label for="house">House Number:</label>
          <input type="text" id="house" v-model="houseNum">
        </div>
        <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      try {
        const newSpot = await newOwner.addCampingSpot(formData);
        if (newSpot) {
          this.ownerCampintSpots.push(newSpot); 
